...
<!-- Mirrored from betipster.netlify.app/live/tipster-details by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 11:05:34 GMT -->
...
<head>
    ...
    <!-- flaticon css  -->
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri());?>/assets/fonts/flaticon.css">
    <!-- animate.css -->
  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="0">
                ...
                <div class="profile-step">
                    <div class="row justify-content-between">
                            ...
                            <div class="part-bio">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span class="text">
                                            <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/bookamkers/logo-1.png" alt="">
                                        </span>
                                    </li>
                                    <li>
                        ...
                        <div class="col-sm-7 col-xl-4 col-lg-4 order-first order-xl-0 order-lg-0 text-center  d-xl-flex d-lg-flex d-block align-items-center">
                            <div class="part-img">
                                <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/people/team-member-3.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-sm-5 col-xl-3 order-last order-sm-first order-xl-2 order-lg-0 col-lg-3 d-xl-flex d-sm-flex d-md-flex d-block align-items-center">
                            <div class="part-statics">
                                <div class="single-statics">
                                    <span class="icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/icon/impact.png" alt="">
                                    </span>
                                ...
                                <div class="single-statics">
                                    <span class="icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/icon/subscription.png" alt="">
                                    </span>
                                    <div class="part-stats">
                                ...
                                <div class="single-statics">
                                    <span class="icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/icon/view.png" alt="">
                                    </span>
                                    <div class="part-stats">
                    ...
                    <div class="about-widget">
                        ...
                        <div class="support">
                            <ul>
                                <li>
                                    <span class="icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/svg/email.svg" alt="">
                                    </span>
                                    <span class="text">
                                ...
                                <li>
                                    <span class="icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/svg/phone-call.svg" alt="">
                                    </span>
                                    <span class="text">
    ...
    <!-- clock js -->
    <script src="<?php echo esc_url(get_template_directory_uri());?>/assets/js/clock.min.js"></script>
    <!-- chart js -->
    <script src="../../cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.min.js"></script>
    <script src="<?php echo esc_url(get_template_directory_uri());?>/assets/js/chart-js-initialize.js"></script>
    <!-- main -->
    <script src="<?php echo esc_url(get_template_directory_uri());?>/assets/js/main.js"></script>
    </body>

<!-- Mirrored from betipster.netlify.app/live/tipster-details by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 11:05:39 GMT -->
</html>